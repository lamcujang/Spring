...
@Builder
@Entity
@Table(name = "d_province", schema = "pos")
public class Province extends AbstractMappedEntity {

    @Id
    @Column(name = "d_province_id", nullable = false, precision = 10)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "d_province_sq")
    @SequenceGenerator(name = "d_province_sq", sequenceName = "d_province_sq", allocationSize = 1)
    private Integer id;

...
public class PurchaseOrderController {
    ...
    private final PurchaseOrderClientService entityClientService;
    ...
    public ResponseEntity<GlobalReponse> findById(@PathVariable("poId") final Integer poId) {
        ...
        return ResponseEntity.ok(this.entityClientService.findById(poId).getBody());
    }

    @GetMapping("/findAllDetail")
    public ResponseEntity<GlobalReponsePagination> findAll(@SpringQueryMap PODetailVRequest request)
    {
    ...
    public ResponseEntity<GlobalReponse> deletePurchaseOrder(@PathVariable("id") final Integer id) {
        ...
        return ResponseEntity.ok(this.entityClientService.deletePurchaseOrder(id).getBody());
    }
}

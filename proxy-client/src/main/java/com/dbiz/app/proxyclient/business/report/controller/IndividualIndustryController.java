...
import com.dbiz.app.proxyclient.business.report.service.IndividualIndustryClientService;
...
public class IndividualIndustryController {
	
	private final IndividualIndustryClientService clientService;
	...
	@GetMapping("/findAll")
	public ResponseEntity<GlobalReponsePagination> findAll(@SpringQueryMap final IndividualIndustryQueryRequest request) {

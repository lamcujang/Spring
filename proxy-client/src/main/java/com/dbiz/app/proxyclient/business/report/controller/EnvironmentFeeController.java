...
import com.dbiz.app.proxyclient.business.report.service.EnvironmentFeeClientService;
...
public class EnvironmentFeeController {
	
	private final EnvironmentFeeClientService clientService;
	...
	@GetMapping("/findAll")
	public ResponseEntity<GlobalReponsePagination> findAll(@SpringQueryMap final EnvironmentFeeQueryRequest request) {

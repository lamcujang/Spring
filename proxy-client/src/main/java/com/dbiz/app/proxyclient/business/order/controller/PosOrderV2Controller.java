...
import com.dbiz.app.proxyclient.business.order.service.PosOrderV2ClientService;
...
@Slf4j
public class PosOrderV2Controller {
    private final PosOrderV2ClientService entityClientService;

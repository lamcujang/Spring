...
import com.dbiz.app.proxyclient.business.report.service.TaxPaymentMethodClientService;
...
public class TaxPaymentMethodController {
	
	private final TaxPaymentMethodClientService clientService;
	...
	@GetMapping("/findAll")
	public ResponseEntity<GlobalReponsePagination> findAll(@SpringQueryMap final TaxPaymentMethodQueryRequest request) {

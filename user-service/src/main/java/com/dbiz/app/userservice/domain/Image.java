...
public class Image implements Serializable {
    ...
    @Size(max = 36)
//    @NotNull
    @Column(name = "d_image_uu" ,columnDefinition = "UUID DEFAULT uuid_generate_v4()", insertable = false, updatable = false)
    private String dImageUu;

    @PrePersist
    protected void onCreate() {
        AuditInfo auditInfo = com.dbiz.app.tenantservice.domain.AuditContext.getAuditInfo();
            if (this.dImageUu == null) {
                this.dImageUu = UUID.randomUUID().toString();
            }

...
public class PosOrderV2ServiceImpl implements PosOrderV2Service {
...
//        dto.setDiscountAmount(sumFlatAmt == null ? BigDecimal.ZERO : sumFlatAmt);
    ...
    public List<PosOrderline> processOrderLines(PosOrderDto paramDto, PosOrder finalEntitySave) {
        //clear all posorderline in pos order
        posOrderlineRepository.cancelAllLineByPosOrderId(finalEntitySave.getId());

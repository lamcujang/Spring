...
public class PosOrderResource {
    ...
    private final PosOrderService service;
    ...
    public ResponseEntity<GlobalReponse> cancelCompletedOrder(@PathVariable("invoiceId") final Integer id) {
        log.info("*** PosOrder, resource; cancel invoiceId id {} *",id);
